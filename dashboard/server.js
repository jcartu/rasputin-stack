...
const GOOGLE_REDIRECT_URI =
  process.env.GOOGLE_REDIRECT_URI || 'https://example.com';
const WHITELISTED_EMAILS = ['admin@example.com']; // Only these emails can authenticate
...
<div class="login-box">
<h1>⚡ NEXUS</h1>
<p class="sub">Rasputin Neural Dashboard — example.com</p>
