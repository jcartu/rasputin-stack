    ...
    while total < target_chars:
        ...
        if turn % 2 == 0:
            ...
            content = f"Let's discuss {topic}. " + (
                "Here's the detailed data from the last 30 days including all metrics, "
                "conversion rates, deposit amounts, player segments, geographic breakdown, "
                "and comparison with previous periods. I need a thorough analysis with "
                "actionable recommendations. The raw numbers show significant variance "
                "across different markets and we need to understand why. " * 20
            )
        else:
            role = "assistant"
            content = (
...
def main():
    ...
    if working >= 3:
        print("   ✅ Failover chain is resilient — at least 3 providers can handle the load")
    else:
