...
- [x] **gog OAuth for admin@operator.com — COMPLETE with ALL scopes**: Gmail (read/modify/send/settings), Calendar (events/readonly), Drive, Sheets, Docs, Contacts, Fitness (activity/heart_rate/body/sleep), OpenID/userinfo. Verified all APIs working.
- [x] **Google AI subscription identified**: admin@operator.com has **Google One AI Premium** (AI Pro tier) — 8,790 HUF/mo (~$23) via PayPal since Oct 19, 2025. Monthly billing on the 19th. NOT Ultra ($250/mo).
...
- [x] **Found ELF contact info**: Email: info@legal-proceedinglaw.net, phones: +7-995-260-4147 / +7-911-601-0417, address: Paveletskaya Embankment 8B, city-hq 115114. Also found on UK FCDO professional services directory and Justia.
...
- **j@mail99.me for Antigravity, not admin@operator.com**: j@mail99.me is the account with the Antigravity subscription.
...
6. **Await admin's confirmation on ELF email draft** — ready to send to info@legal-proceedinglaw.net when admin says go
...
- **admin's email accounts**: admin@operator.com (primary, gog configured, AI Pro), j@mail99.me (Antigravity/free Opus access)
...
- **Rasputin/JARVIS/ALFIE Architecture** (audited Feb 17):
  ...
  - **OpenManus** (`/home/admin/rasputin/OpenManus/`): Live at `https://manus.rasputin.to/`, ManusAgent with 5 tool types, 10+ published projects, WebSocket streaming
