...
def generate_reflection(days, memories, patterns, high_importance, action_items, lessons, decisions, mistakes):
    ...
    # Category breakdown
    reflection.append(f"## 🏷️  Memory Categories")
    ...
    # Top topics
    reflection.append(f"## 🎯 Top Topics")
    ...
    if patterns['hourly_activity']:
        reflection.append(f"## ⏰ Activity Pattern (by hour)")
    ...
    if high_importance:
        reflection.append(f"## ⭐ High Importance Memories")
    ...
    # Decisions made
    if decisions:
        reflection.append(f"## 🎯 Key Decisions")
    ...
    # Lessons learned
    if lessons:
        reflection.append(f"## 📚 Lessons Learned")
    ...
    # Mistakes/problems
    if mistakes:
        reflection.append(f"## ⚠️  Issues & Mistakes")
    ...
    # Action items
    if action_items:
        reflection.append(f"## ✅ Action Items Mentioned")
    ...
    # Insights
    reflection.append(f"## 💡 Insights & Recommendations")
