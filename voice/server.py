#!/usr/bin/env python3
"""
Realtime Voice Communication Server
==========================================
...
async def fetch_context(query: str) -> str:
    try:
        proc = await asyncio.create_subprocess_exec(
            "python3", str(Path.home() / ".openclaw/workspace/second_brain.py"), query,
...
# ── LLM ──
SYSTEM_PROMPT = """You are an autonomous AI assistant running on local infrastructure.
You have access to a vector memory database for context-aware responses.
Be concise and helpful in voice conversations."""
...
# ── Main ──
def main():
    log.info("🎙️ Voice Server starting...")
