...
┌───────────────────────────▼─────────────────────────────────┐
│                   LLM ROUTING PROXY                         │
│   cartu-proxy v11 — Session Affinity · Quality Gate         │
...
|---------|------|---------|---------|
| cartu-proxy | 8889 | PM2 | Multi-provider LLM routing |
...
5. LLM request hits **cartu-proxy** → session-affinity selects provider
